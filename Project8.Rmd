...
```
There are `r dim.training4-1` independent variables and 1 target variable left to build the model.
```{r, results='hide',warning=FALSE, cache=TRUE}
...
rf.time<-system.time(rf.training<-randomForest(classe~.,data=training4,ntree=100, importance=TRUE))
